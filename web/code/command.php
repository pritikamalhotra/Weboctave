...
//       $command = $_POST['commands'];
      ...
      else
      {
        ...
        // if(!$this->anonymous)  //old policy
        {
          ...
          if($_fun->ExtractAllFunctions($command,$farr))
          {
          ...
          {
            echo("<BR>Warning: Failed to retrieve functions from the given command automatically. <BR>\n");
          }
        }
      }
...
<p><textarea name="commands" rows="24" cols="120">';
echo $command;
echo '
</textarea>
